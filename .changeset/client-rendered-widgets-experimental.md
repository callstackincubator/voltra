...
sheet). In development the bundle is served by Metro and editing the JSX hot-reloads the
home-screen widget; in release builds the bundle is baked into the widget extension at build time.
