...
class VoltraNotificationManager(private val context: Context) {
    ...
    suspend fun updateLiveUpdate(notificationId: String, payload: String) = withContext(Dispatchers.Default) {
    ...
    fun isLiveUpdateActive(updateName: String): Boolean {
        return activeNotifications.containsKey(updateName)
    }
