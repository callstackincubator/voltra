...
describe('Compression', () => {
  test('Small payload compression', async () => {
    ...
    const result = await renderLiveActivityToString({ lockScreen: <Voltra.Text>{content}</Voltra.Text> })
  ...
  test('Repetitive content', async () => {
    const items = Array.from({ length: 100 }, (_, i) => <Voltra.Text key={i}>item</Voltra.Text>)
  ...
  test('Unique content', async () => {
    ...
    const resUnique = await renderLiveActivityToString({ lockScreen: <Voltra.Text>{unique}</Voltra.Text> })
    const resRepetitive = await renderLiveActivityToString({ lockScreen: <Voltra.Text>{repetitive}</Voltra.Text> })
  ...
  test('Base64 overhead', async () => {
    ...
    const base64 = await renderLiveActivityToString({ lockScreen: <Voltra.Text>{content}</Voltra.Text> })
