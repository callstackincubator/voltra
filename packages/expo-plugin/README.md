...
`@voltra/expo-plugin` contains the Expo config plugin used by Voltra to configure iOS Live Activities, widget extensions, and Android widgets during `expo prebuild`.
