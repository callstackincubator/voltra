...
Once you have [installed Voltra](../getting-started/installation), configure the iOS Expo plugin and use `@use-voltra/ios` for JSX.
...
Add the iOS client plugin to your `app.json` or `app.config.js`. For iOS, you typically need to specify a `groupIdentifier` to enable data sharing between your main app and the Live Activity extension.
